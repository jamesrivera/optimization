...
var resizePizzas = function(size) { 
  ...
  var randomSizedDiv = document.getElementById("randomPizzas");

    // Change value for the size of the pizza above the slider
    switch(size) {
      case "1":
        document.getElementById("pizzaSize").innerHTML = "Small";
        randomSizedDiv.className = "row smallPizzas";
        break;
      case "2":
        document.getElementById("pizzaSize").innerHTML = "Medium";
        randomSizedDiv.className = "row mediumPizzas";
        break;
      case "3":
        document.getElementById("pizzaSize").innerHTML = "Large";
        randomSizedDiv.className  = "row largePizzas";
        break;
      default:
...
// Listens to request animation frame
function scrolled() {
  requestAnimationFrame(updatePositions);
}

// Changes position of pizzas
function updatePositions() {
  ...
  for (var i = 0; i < len; i++) {
    var move = Math.sin(phase + (i % 5)) * 100;
...
// Creates pizzas based on current window height
...
// updatePositions on scroll
window.addEventListener('scroll', scrolled);

// Creates pizzas on page load.
document.addEventListener('DOMContentLoaded', createPizza);

// Re-creates pizza based on screen size
